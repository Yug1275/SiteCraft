            ...
            <CardContent className="space-y-4">
              {loading ? (
                ...
                lowStockItems.map((item) => (
                  <div key={item.id} className="p-3 rounded-lg border-l-4 border-l-red-500 bg-red-50 dark:bg-red-950/20">
                    ...
                    <Progress value={(item.current_stock / item.minimum_stock) * 100} className="h-1 mt-2" />
                  </div>
                ))
              )}
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              ...
              <Button asChild variant="outline" className="h-20 flex-col gap-2 bg-transparent rounded-xl">
                <Link href="/labor">
